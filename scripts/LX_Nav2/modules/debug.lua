...
-- Constants
local LOG_FILE = "LX_Nav2.log"
local PERF_LOG_FILE = "LX_Nav2_perf.log"
...
function Debug.init()
    ...
    Debug.log("=== LX_Nav2 Debug Initialized ===")
